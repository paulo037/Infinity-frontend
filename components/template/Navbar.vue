<template>
  <v-app-bar height="60px" app class="secondary" elevation="1">
    ...
    <v-toolbar-items v-if="!hide">
      ...
      <NuxtLink class="text-decoration-none" to="/login" v-if="$auth.loggedIn">
        <v-btn
          text
